...
| `Patch_v2.6_VISUAL_TEST2` | TEST1 群体显示修复：只隐藏灰棕色转世重生圆圈，继续执行每队兵种起身、音效和逐帧刷新 | `3232c2e7dc815046e120d88c2c5ba3c84190ff326b220db6a231731a37a39713` |

每个测试版均保留 ZIP、测试说明和 JSON/Markdown 构建清单。重组前的根目录项目说明保存在 `README_before_download_layout.md`。

`Patch_v2.6_VISUAL_TEST1` 的单体测试通过，但群体复活多队尸体时缺少逐队起身刷新，贴图会停留为地面尸体直到鼠标移入；后续测试应使用 `TEST2`。
