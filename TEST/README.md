...
| `Patch_v2.6_VISUAL_TEST5` | 保留 TEST4 全部已通过功能，只把治愈施法日志前移到各队“起死回生”日志之前 | `a229231636aaf4a53dac44f13edd4ce831e678d04352aadb5814d115564563a6` |
...
`Patch_v2.6_VISUAL_TEST4` 已通过全部实机门禁，包括单体/群体复活、起身与站立状态、音效/动画隔离、战后永久保留、亡灵负例、重叠尸体和被占格尸体。其唯一遗留问题是战斗日志先显示各队“起死回生”，随后才显示“英雄施放治愈”。`TEST5` 只调整这项日志顺序，后续测试使用 `TEST5`。
