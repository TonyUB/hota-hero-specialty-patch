...
| `Patch_v2.6_VISUAL_TEST3` | 保留合法特效对象但令圆圈帧越界；仅保留治愈术演出/音效与兵种起身动作，跳过复活音效 | `f2e9a0f159c86d7f9e35a83731e10ea7e07566e963fb31c7610910f44eca2353` |
...
`Patch_v2.6_VISUAL_TEST2` 已撤回：该版用效果 ID `-1` 清空圆圈对象，HotA 1.8.0 的额外绘制函数在兵种起身刷新时没有检查空指针，导致 `HotA.dll+0x64AFF` 崩溃。后续测试只使用 `TEST3`，不要安装 TEST2。
