#!/usr/bin/env python3
"""Verify V1.04 combat-log candidate invariants and reproducibility."""
...
from build_hota_new_hero_v104_log_test1 import (
    APPEND_HELPER_VA,
    BUILD_NAME,
    CORPSE_CALC_CALL_VA,
...
def main() -> int:
    ...
    print("V1.03 F6 Direct sample matrix=PASS")
