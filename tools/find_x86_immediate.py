#!/usr/bin/env python3
"""Find x86 PE instructions containing a selected immediate operand."""
...
def main() -> int:
    ...
    parser.add_argument("immediate", type=number)
    ...
    for section in pe.sections:
        ...
        for instruction in engine.disasm(data[start:start + size], va):
            ...
            if any(
                ...
                and (operand.imm & 0xFFFFFFFF) == (args.immediate & 0xFFFFFFFF)
    ...
    print(
        ...
        f"immediate=0x{args.immediate:X} matches={len(matches)}"
    )
