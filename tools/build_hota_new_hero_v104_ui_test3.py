#!/usr/bin/env python3
"""Build the V1.04 UI/log candidate from accepted V1.03.
...
messages.  TEST3 keeps the accepted F6 target-tier source (the copied
...
BUILD_NAME = "HOTA_NEW_HERO_V1.04_UI_TEST3"
